...
const CHANNEL_SEEDS = [
  {
    ...
    sort: 1,
    config: {
      note: "BR-007 PENDING credentials — TEMP harness only",
  ...
  },
  {
    ...
    sort: 3,
    config: {
      note: "BR-007/BR-009 PENDING; disabled until multi-currency live",
      productionReady: false,
      provider: "TEMP",
      callbackConfigured: false,
      timeoutMs: null,
...
const CONFIG_SEEDS: Array<{ key: string; value: Record<string, unknown> }> = [
  {
    ...
    value: {
      ...
      orderTtlMinutes: 30,
      productionReady: false,
      note: "BR-005 PENDING — admin-replaceable placeholders (NOT Zhao law)",
    },
  },
  {
    key: "withdrawal",
    value: {
      ...
      productionReady: false,
      note: "BR-006 PENDING — admin-replaceable placeholders (NOT Zhao law)",
    },
  },
  {
    key: "checkin",
